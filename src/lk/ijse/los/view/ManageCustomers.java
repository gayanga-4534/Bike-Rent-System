...
public class ManageCustomers extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, -1, 40));
        ...
        btnRegister1.setBackground(new java.awt.Color(254, 254, 254));
        btnRegister1.setFont(new java.awt.Font("Ubuntu", 1, 13)); // NOI18N
        btnRegister1.setText("Register Customer");
        btnRegister1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnRegister1ActionPerformed(evt);
            }
        });
        add(btnRegister1, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 250, 170, 40));
        ...
        add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 310, 170, 40));

        btnUnregister.setBackground(new java.awt.Color(254, 254, 254));
        btnUnregister.setFont(new java.awt.Font("Ubuntu", 1, 13)); // NOI18N
        btnUnregister.setText("Update State");
        btnUnregister.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUnregisterActionPerformed(evt);
            }
        });
        add(btnUnregister, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 370, 170, 40));
    ...
    private void btnRegister1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegister1ActionPerformed
        ...
        String contact= txtTP.getText();
        String address1= txtAddress1.getText();
        String address2= txtAddress2.getText();
        String city=txtCity.getText();
        String disctrict=txtDistrict.getText();
        ...
        try{
            ...
            boolean isSaved=new CustomerController().savePatient(p1);
    ...
    private void btnUnregisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUnregisterActionPerformed
       if(txtNic.getText().trim().length()>4){
            ...
            try {
                ...
                customer p1= new customer(nic,name,contact,address1,address2,city,disctrict);
                
                
                if(new CustomerController().updateState(p1)){
